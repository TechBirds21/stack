/*
  # Sample Data Migration for Home & Own
...
-- Insert sample bookings (using property IDs from the inserted properties)
...
FROM properties p 
WHERE p.title = 'Luxury 4BHK Penthouse with Sea View'
LIMIT 1;
...
FROM properties p 
WHERE p.title = 'Spacious 3BHK Independent House'
LIMIT 1;
...
SELECT 
  ...
  '+91 9876543219',
  'Hi, I am interested in this apartment. Can you share more details about the lease terms?',
  'new'
FROM properties p 
WHERE p.title = 'Cozy 2BHK Near Beach'
LIMIT 1;
...
SELECT 
  ...
  '+91 9876543220',
  'Interested in the luxury villa. Is home loan assistance available?',
  'new'
FROM properties p 
WHERE p.title = 'Luxury Villa in Gated Community'
LIMIT 1;