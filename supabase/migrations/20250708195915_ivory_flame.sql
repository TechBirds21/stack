/*
  ...
  1. New Tables
    - `documents` - File management system for users, properties, and admin
    - `notifications` - Real-time notification system for admin dashboard
    - `system_counters` - Custom ID generation system

  2. Custom ID System
    - Users: H&000001, H&000002, etc.
    - Properties: H&000001, H&000002, etc.
    - Agent Licenses: HO0011, HO0012, etc.

  3. Notification System
    - User registration notifications
    - Inquiry and booking notifications
