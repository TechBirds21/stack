/*
  # Email Verification and Agent Notification System

  1. New Tables
    - `email_verification_tokens` - Manages email verification tokens with expiration
    - `agent_inquiry_assignments` - Tracks agent assignments for inquiries
    - `notification_queue` - Queue for email notifications

  2. Enhanced Tables
    - `users` - Added email_verified and email_verified_at columns
    - `inquiries` - Added inquiry_type, location, and assigned_agent_id columns

  3. Functions
    - Email verification token generation and validation
    - Agent assignment system with automatic notifications
    - Enhanced notification triggers

  4. Security
    - RLS policies for all new tables
    - Proper access control for agents and admins
*/
  ...
  LOOP
    ...
    VALUES (
      ...
      format('
        ...
        <body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 20px;">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="https://your-domain.com/agent/assignments/%s?action=accept" 
              ...
              <a href="https://your-domain.com/agent/assignments/%s?action=decline" 
      ...
      ',
        ...
        COALESCE(inquiry_record.phone, 'Not provided'),
  ...
  IF response_param = 'accepted' THEN
    ...
    VALUES (
      ...
      ',
        ...
        agent_record.email,
        COALESCE(agent_record.phone_number, 'Not provided'),
