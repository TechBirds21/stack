/*
# Sample Data Migration for Home & Own Platform

1. New Sample Data
   - Users (buyers, sellers, agents) with proper UUIDs
   - Properties with complete details and relationships
...
2. Data Structure
   ...
   - Sample images and amenities included

3. Features Added
   - Agent assignments for bookings
...
-- Insert sample bookings with agent assignments
