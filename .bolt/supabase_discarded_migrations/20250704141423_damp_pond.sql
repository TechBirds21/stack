/*
  # Add Dummy Data for Home & Own

  1. Sample Users
    - Buyers, sellers, and agents with proper verification status
    - Diverse user profiles across different cities
  
  2. Sample Properties
    - Mix of sale and rental properties
    - Properties in Visakhapatnam and Hyderabad
    - Different property types and price ranges
  
  3. Sample Bookings and Inquiries
    - Tour requests from buyers
    - Property inquiries from both registered and anonymous users
*/
...
-- Insert additional properties with proper UUIDs
INSERT INTO properties (
  id, title, description, price, monthly_rent, security_deposit, property_type, 
  bedrooms, bathrooms, area_sqft, address, city, state, zip_code,
  latitude, longitude, images, amenities, owner_id, status, featured, verified, listing_type,
...
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', NULL, 'Sneha Iyer', 'sneha.iyer@email.com', '+91 9876543220', 'Interested in the luxury villa. Is home loan assistance available?', 'new'),
('b2c3d4e5-f6g7-8901-bcde-f23456789012', NULL, 'Amit Verma', 'amit.verma@email.com', '+91 9876543221', 'Looking for a budget apartment for investment. Is this a good option?', 'responded');