/*
# Email Verification and Agent Assignment System

1. New Tables
   - `email_verification_tokens` - Stores email verification tokens
   - `agent_inquiry_assignments` - Manages agent assignments for inquiries
   - `notification_queue` - Queues email notifications for sending
...
3. Functions
   ...
   - Agent assignment system for inquiries
   - Enhanced notification triggers

4. Security
   - RLS policies for all new tables
   - Proper access controls for agents and admins
*/
...
ALTER TABLE agent_inquiry_assignments ENABLE ROLS LEVEL SECURITY;
