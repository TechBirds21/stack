...
const AdminUsers = () => {
  ...
  const mockUsers: AdminUser[] = [
    ...
    },
    {
      id: 3,
      fullName: 'Admin',
      email: 'shanmugarajan@cron24.com',
      role: 'Admin',
      primaryAdmin: 'No',
      status: 'Active'
    },
        ...
        <div className="p-6">
              ...
              <tbody>
                {filteredUsers.map((user) => (
                  <tr key={user.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3">{user.primaryAdmin}</td>
                    <td className="px-4 py-3">
                      <span className="text-[#22C55E]">{user.status}</span>
                    </td>
                    <td className="px-4 py-3">
                      <div className="flex gap-2">
          ...
          <div className="flex justify-between items-center mt-6">
            ...
            <div className="flex gap-2">
              ...
              <button className="px-3 py-1 bg-[#1E3A8A] text-white rounded">1</button>
              <button 
                className="px-3 py-1 bg-[#1E3A8A] text-white rounded disabled:opacity-50"
                disabled
              >
