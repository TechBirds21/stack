...
const Sliders = () => {
  ...
  const mockSliders: Slider[] = [
    {
      id: 1,
      title: 'No Brokers, Connect buyers and sellers, No negotiation',
    ...
    <div className="p-6">
      ...
      <div className="bg-white rounded-[2rem] shadow-sm overflow-hidden">
        <div className="bg-[#1E3A8A] p-6 flex justify-between items-center">
          <h2 className="text-xl font-semibold text-white">Sliders</h2>
          <button 
              ...
              <tbody>
                {filteredSliders.map((slider) => (
                  <tr key={slider.id} className="border-b">
                    ...
                    <td className="px-4 py-3">{slider.title}</td>
